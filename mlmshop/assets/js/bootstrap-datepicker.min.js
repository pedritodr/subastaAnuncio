!function (a, b) {
    ...
    l.prototype = {
        constructor: l, _process_options: function (b) {
            ...
            this.isInput ? this._events = [[this.element, {
                focus: a.proxy(this.show, this), keyup: a.proxy(function (b) {
            ...
            }], [this.component, {click: a.proxy(this.show, this)}]] : this.element.is("div") ? this.isInline = !0 : this._events = [[this.element, {click: a.proxy(this.show, this)}]], this._events.push([this.element, "*", {
            ...
            if (!this.isInline) {
                var b = this.picker.outerWidth(), c = this.picker.outerHeight(), d = 10, e = j.width(), f = j.height(), g = j.scrollTop(), h = parseInt(this.element.parents().filter(function () {
                        return "auto" !== a(this).css("z-index")
                    }).first().css("z-index")) + 10, i = this.component ? this.component.parent().offset() : this.element.offset(), k = this.component ? this.component.outerHeight(!0) : this.element.outerHeight(!1), l = this.component ? this.component.outerWidth(!0) : this.element.outerWidth(!1), m = i.left, n = i.top;
            ...
            var d, e = new Date(this.viewDate), f = e.getUTCFullYear(), g = e.getUTCMonth(), h = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCFullYear() : -1 / 0, i = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCMonth() : -1 / 0, j = 1 / 0 !== this.o.endDate ? this.o.endDate.getUTCFullYear() : 1 / 0, k = 1 / 0 !== this.o.endDate ? this.o.endDate.getUTCMonth() : 1 / 0, l = q[this.o.language].today || q.en.today || "", m = q[this.o.language].clear || q.en.clear || "";
            ...
            var n = c(f, g - 1, 28), o = r.getDaysInMonth(n.getUTCFullYear(), n.getUTCMonth());
    ...
    a.fn.datepicker = function (c) {
        ...
        return this.each(function () {
            var h = a(this), i = h.data("datepicker"), j = "object" == typeof c && c;
            if (!i) {
                var k = f(this, "date"), n = a.extend({}, o, k, j), p = g(n.language), q = a.extend({}, o, p, k, j);
    ...
    var q = a.fn.datepicker.dates = {
        ...
        parseDate: function (d, e, f) {
            ...
            var h, i, j, k = /([\-+]\d+)([dmwy])/, m = d.match(/([\-+]\d+)([dmwy])/g);
