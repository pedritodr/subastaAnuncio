...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small><?= translate('update_color_product_lang'); ?></small>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?= translate('update_color_product_lang'); ?></li>
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?= translate('update_color_product_lang'); ?></h3>
                    </div>
                    <div class="box-body">

                        <?= get_message_from_operation(); ?>

                        <?= form_open_multipart("color_product/update"); ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="hidden" name="color_id" value="<?= $color_object->color_producto_id; ?>" />

                                            <input type="text" class="form-control input-sm" name="name" required placeholder="<?= translate('nombre_lang'); ?>" value="<?= $color_object->nombre; ?>">
                                        </div>
