            ...
            <div class="col-xs-12">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <?= form_open_multipart("cate_anuncio/update"); ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="hidden" name="cate_anuncio_id" value="<?= $cate_anuncio_object->cate_anuncio_id; ?>" />

                                            <input type="text" class="form-control input-sm" name="nombre" required placeholder="<?= translate('nombre_lang'); ?>" value="<?= $cate_anuncio_object->nombre; ?>">
                                        </div>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-text-height"></i></span>
                                            <input type="text" class="form-control input-sm" name="orden" required value="<?= $cate_anuncio_object->orden; ?>" placeholder="<?= "Orden" ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-9">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-image"></i></span>
                                            <input type="file" class="form-control input-sm" name="banner" placeholder="<?= translate('image_lang'); ?>">
                                        </div>
                                    </div>
                                </div>
