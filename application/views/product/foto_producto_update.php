<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            | <a href="<?= site_url('product/foto_coleccion/' . $foto_producto_object->producto_id); ?>" class="btn btn-default"><i class="fa fa-arrow-circle-left"></i> <?= translate('back_lang'); ?>
            </a>
        </h1>
        <ol class="breadcrumb">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="foto_producto_id" value="<?= $foto_producto_object->foto_producto_id; ?>" />
