...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small><?= translate('update_cat_lang'); ?></small>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?= translate('update_cat_lang'); ?></li>
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?= translate('update_cat_lang'); ?></h3>
                    </div>
                    <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="hidden" name="categoria_id" value="<?= $categoria_object->categoria_id; ?>" />

                                            <input type="text" class="form-control input-sm" name="name_espa" required placeholder="<?= translate('nombre_lang'); ?>" value="<?= $categoria_object->name_espa; ?>">
                                        </div>
