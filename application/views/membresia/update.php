                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i><strong>N</strong></i></i></span>
                                            <input required type="number" class="form-control input-sm" name="order" value="<?= $membresia_object->orden ?>" placeholder="<?= "Orden"; ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i><strong>#</strong></i></i></span>
                                            <input required type="text" class="form-control input-sm" name="color" value="<?= $membresia_object->color ?>" placeholder="<?= "#fff"; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
