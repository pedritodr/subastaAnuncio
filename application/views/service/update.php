            ...
            <div class="col-xs-12">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <input type="hidden" name="service_id" value="<?= $service_object->service_id;?>" />
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-6" >
                                    ...
                                    <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="resumen" value="<?= $service_object->resumen;?>" required />
                                    ...
                                    <div class="col-lg-6" >
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-image"></i></span>
                                            <input type="text" class="form-control" name="icono" value="<?= $service_object->icono?>" />
                                        </div>
                                    </div>
