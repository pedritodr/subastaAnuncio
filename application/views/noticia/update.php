...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small><?= translate('update_noticia_lang'); ?></small>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?= translate('update_noticia_lang'); ?></li>
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?= translate('update_noticia_lang'); ?></h3>
                    </div>
                    <div class="box-body">

                        <?= get_message_from_operation();?>
                        <?= form_open_multipart("noticia/update"); ?>
                        <input type="hidden" name="noticia_id" value="<?= $noticia_object->noticia_id;?>" />
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-4" >
