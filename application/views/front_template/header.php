                  ...
                  <div class="pull-right">
                     <ul class="listnone">
                        ...
                        <?php if (!$this->session->userdata('role_id')) { ?>
                           ...
                           <li><a href="<?= site_url('login') ?>"><i class="fa fa-sign-in"></i> <?= translate("login_lang"); ?></a></li>
                        ...
                        <?php if ($this->session->userdata('role_id')) { ?>
                           <li class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                 <li><a href="<?= site_url('perfil'); ?>"><i class="fa fa-user-o" aria-hidden="true"></i><?= translate("perfil_lang"); ?> </a></li>
                  ...
                  <div class="col-lg-12 col-md-12">
                     ...
                     <ul class="menu-links">
                        ...
                        <?php if (!$this->session->userdata('user_id')) { ?>
                           <li>
                              <a href="<?= site_url('membresia') ?>"> <?= translate('menbresi_lang') ?> <i></i></a>
                           </li>
                        <?php } else { ?>
