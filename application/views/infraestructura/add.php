<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?= 'Adicionar área'; ?></li>
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <?= form_open_multipart("infraestructura/add"); ?>
                            ...
                            <div class="col-lg-12">
                                ...
                                <button type="submit" class="btn btn-primary" style="margin-top:15px;"><i class="fa fa-check-square"></i> <?= translate('guardar_info_lang');?></button>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="texto" class="form-control" style="height:150px;"></textarea>
                                    </div>
                                    </div>
