...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            | <a href="<?= site_url('client/listar_destination/' . $client_id); ?>" class="btn btn-default"><i class="fa fa-arrow-circle-left"></i> <?= translate('back_lang'); ?>
            </a>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <?= form_open_multipart("client/add_marcacion"); ?>
