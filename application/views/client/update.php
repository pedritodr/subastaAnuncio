                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-skype"></i></span> <input type="text" class="form-control input-sm" name="skype_contact" placeholder="<?= translate('skype_person_contact_lang'); ?>" value="<?= $client_object->skype_contact; ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-skype"></i></span> <input type="text" class="form-control input-sm" name="skype_person" placeholder="<?= translate('skype_person_pago_lang'); ?>" value="<?= $client_object->skype_person; ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
