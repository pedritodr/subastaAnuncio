     ...
     <div class="main-content-area clearfix">
                         ...
                         <div class="single-anun">
                             ...
                             <div class="box-text">
                                 ...
                                 <div class="desc-points">
                                     ...
                                     <br>
                                     <p class="text-left"><i class="fa fa-eye" aria-hidden="true"></i>
                                         <?= $all_anuncios->views ?></p>
                                     ...
                                     <?php if ($all_anuncios->url != '' || $all_anuncios->url != null) { ?>
                                         <div class="ad-meta"> <a href="<?= $all_anuncios->url ?>" class="btn btn-primary" style="margin-right:4px">Comprar</a> </div>
                                     <?php } ?>
                                 </div>
                                 <div class="clearfix"></div>
                             </div>
         ...
         <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC0jIY1DdGJ7yWZrPDmhCiupu_K2En_4HY&amp;callback=initMap">
         </script>
