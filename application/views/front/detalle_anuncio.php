...
.box-text {
    ...
    padding: 20px 30px;
     ...
     <div class="main-content-area clearfix">
                         ...
                         <div class="single-anun">
                                     ...
                                     <ul class="slides slide-main">
                                         <li class="flex-active-slide">
                                             ...
                                             <img style="width:100%" draggable="false"
                                                 src="<?= base_url($all_anuncios->anuncio_photo) ?>" alt="">
                                             <?php } else { ?>
                                             <img style="width:100%" draggable="false"
                                                 src="<?= $all_anuncios->anuncio_photo ?>" alt="">
                                         ...
                                         <li>
                                             ...
                                             <img style="width:100%" draggable="false"
                                                 src="<?= base_url($item->photo_anuncio) ?>" alt="">
                                             <?php } else { ?>
                                             <img style="width:100%" draggable="false" src="<?= $item->photo_anuncio ?>"
                                                 alt="">
                             ...
                             <div class="flexslider" id="carousels">
                                 <div class="flex-viewport">
                                     <ul class="slides slide-thumbnail">
                                         ...
                                         <li>
                                             <?php if (strpos($item->photo_anuncio, 'uploads') !== false) { ?>
                                             <img style="width:150px; height:120px" draggable="false"
                                                 src="<?= base_url($item->photo_anuncio) ?>" alt="">
                                             <?php } else { ?>
                                             <img style="width:150px; height:120px" draggable="false"
                                                 src="<?= $item->photo_anuncio ?>" alt="">
                             ...
                             <div class="box-text">
                                 ...
                                 <div class="desc-points">
                                     ...
                                     <br>
                                     <span><strong><?= translate('precios_lang'); ?>
                                             <?= number_format($all_anuncios->precio, 2); ?></strong></span>
                                     <br>
                                     <?php if($all_anuncios->url !='' || $all_anuncios->url != null){?>
                                     <div class="ad-meta"> <a href="<?= $all_anuncios->url ?>" class="btn btn-primary"
                                             style="margin-right:4px">Comprar</a> </div>
                                     <?php } ?>
                                 </div>
                                 <div class="clearfix"></div>
                             </div>
                                         ...
                                         <div class="ads-list-archive">
                                             ...
                                             <div class="col-lg-4 col-md-4 col-sm-4 no-padding">
                                                 ...
                                                 <div class="ad-archive-img">
                                                     <a
                                                         href="<?= site_url(strtolower('anuncio/' . strtolower(seo_url($item->titulo))) . $item->anuncio_id); ?>">
                                                         <!--   <div class="ribbon popular"></div> -->


                                                         <?php if (strpos($item->anuncio_photo, 'uploads') !== false) { ?>
                                                         <img class="img-responsive"
                                                             src="<?= base_url($item->anuncio_photo) ?>" alt="">
                                                         <?php } else { ?>
                                                         <img class="img-responsive" src="<?= $item->anuncio_photo ?>"
                                                             alt="">
                                             ...
                                             <div class="col-lg-8 col-md-8 col-sm-8 no-padding">
                                                 ...
                                                 <div class="ad-archive-desc">
                                                     ...
                                                     <p class="hidden-sm">
                                                         <font style="vertical-align: inherit;">
                                                             <font style="vertical-align: inherit;"><?= $item->corta ?>
                                                             </font>
                                                         </font>
                                                     </p>
                                                     <!-- Ad Features -->
                             ...
                             <div class="white-bg user-contact-info">
                                 <div class="user-info-card">
                                     <div class="user-photo col-md-4 col-sm-3  col-xs-4">
                                         ...
                                         <img class="img-responsive" src="<?= base_url($all_anuncios->photo_perfil) ?>"
                                             alt="">
                                         <?php } else { ?>
                                     ...
                                     <div class="user-information no-padding col-md-8 col-sm-9 col-xs-8">
                                         <span class="user-name"><a
                                                 class="hover-color"><?= $all_anuncios->user ?></a></span><br>
                                         <span class="text-center"><a
                                                 href="https://api.whatsapp.com/send?phone=593<?= $all_anuncios->whatsapp ?>"
                                                 target="_blank">
                                                 <i class="fa fa-whatsapp" aria-hidden="true"></i>
                                                 <?= $all_anuncios->whatsapp ?></a></span>


                                         <div class="item-date">
                                             <span class="ad-pub"><?= translate("publicado_lang"); ?>:
                                                 <?= $all_anuncios->fecha ?></span><br>
                                         </div>
                                     </div>
                                 ...
                                 <div class="ad-listing-meta">
                                     <ul>
                                         ...
                                         <li><?= translate("categories_lang"); ?>:
                                             <span><?= $all_anuncios->categoria ?>/<?= $all_anuncios->subcategoria ?></span>
                                         </li>

                                         <li id="direccion"><?= translate("ubicacion_lang") ?>: <span
                                                 class="color"><?= $all_anuncios->ciudad ?></span></li>
                                     </ul>
                                 </div>
                                 <!--mapa -->
                                 <br>
                                                 ...
                                                 <div class="category-grid-box">
                                                     ...
                                                     <div class="category-grid-img">
                                                         <img class="img-responsive" alt=""
                                                             src="<?= base_url($item->anuncio_photo) ?>">
                                                         <!-- Ad Status -->
                                                         <!-- User Review -->
                                                   ...
                                                   <a href="<?= site_url(strtolower('anuncio/' . strtolower(seo_url($item->titulo))) . $item->anuncio_id); ?>"> <img src="" class="avatar avatar-small" alt=""> </a>
                                                         ...
                                                         <!-- View Details --><a
                                                             href="<?= site_url(strtolower('anuncio/' . strtolower(seo_url($item->titulo))) . $item->anuncio_id); ?>"
                                                             class="view-details"><?= translate("ver_info_lang") ?></a>
                                                     </div>
                                                     <!-- Ad Img End -->
                                                     <div class="short-description">
                                                         <!-- Ad Category -->
                                                         <div class="category-title">
                                                             <span><a><?= $item->categoria ?>/<?= $item->subcategoria ?></a></span>
                                                         </div>
                                                         <!-- Ad Title -->
                                                         <h6>
                                                             <?php if ($item->titulo_corto) { ?>
                                                             <a
                                                                 href="<?= site_url(strtolower('anuncio/' . strtolower(seo_url($item->titulo))) . $item->anuncio_id); ?>"><?= $item->titulo_corto ?></a>
                                                             <?php } else { ?>
                                                             <a
                                                                 href="<?= site_url(strtolower('anuncio/' . strtolower(seo_url($item->titulo))) . $item->anuncio_id); ?>"><?= $item->titulo ?></a>
                                                             <?php } ?>
                                                         </h6>
                                                         <!-- Price -->
                                                         <div class="price">$<?= number_format($item->precio, 2) ?>
                                                         </div>
                                                     </div>
                                                     <!-- Addition Info -->
                                                     <div class="ad-info">
                                                         <ul>
                                                             ...
                                                             <li><i
                                                                     class="fa fa-clock-o"></i><?= translate("publicado_lang"); ?>:
                                                                 <?= $item->fecha ?> </li>
                                                         </ul>
                                                     </div>
                                                 </div>
         ...
         <script async defer
             src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC0jIY1DdGJ7yWZrPDmhCiupu_K2En_4HY&amp;callback=initMap">
         </script>
         ...
         function getReverseGeocodingData(lat, lng) {
             ...
             geocoder.geocode({
                 ...
                 if (status == google.maps.GeocoderStatus.OK) {
                     ...
                     $('#direccion').html("<?= translate("direccion_lang"); ?>:<span class='color'>" +
                         address + "</span>");
                 }
             });
         }
