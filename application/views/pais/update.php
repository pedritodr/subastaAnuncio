            ...
            <div class="col-xs-12">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <?= form_open_multipart("pais/update"); ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="hidden" name="pais_id" value="<?= $pais_object->pais_id; ?>" />

                                            <input type="text" class="form-control input-sm" name="name_pais" required placeholder="<?= translate('nombre_lang'); ?>" value="<?= $pais_object->name_pais; ?>">
                                        </div>
