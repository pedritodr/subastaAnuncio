<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            | <a href="<?= site_url('coleccion/foto_coleccion/' . $coleccion_id); ?>" class="btn btn-default"><i class="fa fa-arrow-circle-left"></i> <?= translate('back_lang'); ?>
            </a>
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <?= form_open_multipart("coleccion/add_foto"); ?>
