...
class Infraestructura_model extends CI_Model
{
    ...
    {
        $this->db->insert('infraestructura', $data);
    ...
    {
        $this->db->where('infraestructura_id', $id);
        $query = $this->db->get('infraestructura');
    ...
    function update($id, $data)
    {
        ...
        $this->db->update('infraestructura');
    ...
    {
        $this->db->where('infraestructura_id', $id);
        $this->db->delete('infraestructura');
        $afec = $this->db->affected_rows();
        if($afec>0)
        {
