...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-11-2019 a las 01:26:33
...
(23, 'anuncio de prueba', '', '', 'esta es una descripcion del anuncio', '', '', 43, './uploads/anuncio/1571335761.jpg', 2147483647, 3, 13, 1, '-78.49847975578615', '-0.16847554041709406', 4);
...
INSERT INTO `membresia_user` (`membre_user_id`, `membresia_id`, `user_id`, `anuncios_publi`, `fecha`, `estado`) VALUES
(10, 1, 3, 0, '2019-10-17', 0),
(11, 1, 3, 0, '2019-10-17', 0),
(12, 1, 3, 0, '2019-10-17', 0),
(13, 1, 3, 0, '2019-10-17', 0),
(14, 2, 3, 0, '2019-10-17', 0),
(15, 1, 3, 0, '2019-10-17', 0),
(16, 1, 3, 0, '2019-10-17', 0),
(17, 2, 3, 0, '2019-10-17', 0);
...
(13, './uploads/photo_anuncio/1571340519.jpg', 0),
(14, './uploads/photo_anuncio/1571340729.jpg', 23),
(15, './uploads/photo_anuncio/1571340969.jpg', 23);
...
(46, 17, './uploads/photo/1569956012.jpg');
...
CREATE TABLE `user` (
  ...
  `security_token` varchar(128) NOT NULL,
  `cedula` varchar(64) NOT NULL,
  `codigo_seguridad` varchar(10) NOT NULL,
  `fecha_vencimiento_codigo` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `user` (`user_id`, `name`, `email`, `password`, `phone`, `role_id`, `is_active`, `photo`, `security_token`, `cedula`, `codigo_seguridad`, `fecha_vencimiento_codigo`) VALUES
(1, 'ruben Dario ', 'rubendario@gmail.com', 'dc1b859c6c5d92073cb0ec8cf9bdb6f6', '4268941', 3, 0, '', '', '', '', '0000-00-00 00:00:00'),
(2, 'Indira Perez', 'indiraepf03@gmail.com', 'dc1b859c6c5d92073cb0ec8cf9bdb6f6', '998724637', 1, 0, '', '', '', '', '0000-00-00 00:00:00'),
(4, 'pedro Duran', 'pedro@datalabcenter.com', 'dc1b859c6c5d92073cb0ec8cf9bdb6f6', '2147483647', 1, 0, '', '', '', '', '0000-00-00 00:00:00'),
(5, 'yadira flores ', 'yaflo62@gmail.com', 'dc1b859c6c5d92073cb0ec8cf9bdb6f6', '2147483647', 2, 0, '', '', '', '', '0000-00-00 00:00:00'),
(6, 'Luis', 'luis@gmail.com', '21232f297a57a5a743894a0e4a801fc3', '980562425', 1, 0, '', '', '', '', '0000-00-00 00:00:00'),
(12, 'Pedrito', 'pedritodr14@gmail.com', 'dc1b859c6c5d92073cb0ec8cf9bdb6f6', '098', 2, 1, '', '7fb57ec2993fae896c0020d1269cc2af', '20', '9375', '2019-11-01 15:15:43');
...
--
ALTER TABLE `anuncio`
  MODIFY `anuncio_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `categoria`
  MODIFY `categoria_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `membresia_user`
  MODIFY `membre_user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `photo_anuncio`
  MODIFY `photo_anuncio_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `puja`
  MODIFY `puja_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `subasta_user`
  MODIFY `subasta_user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
