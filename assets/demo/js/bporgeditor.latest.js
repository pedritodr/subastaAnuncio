...
primitives.orgeditor.Controller.prototype._createWidgets = function () {
    ...
    this.element.find("[name=options-button]").button().click(function () {
        self._onOptionsButtonClick();
    });
    this.element.find("[name=json-button]").button().click(function () {
        self._onJsonButtonClick();
    });
...
primitives.orgeditor.Controller.prototype._getOrgDiagramConfig = function () {
    ...
    result.onItemRender = function (e, data) {
        self.userTemplates[data.templateName].onRender(e, data, self.options);
    };
    result.onMouseClick = function (e, data) {
        self._onMouseClick(e, data);
    };
    ...
    if (this.options.editMode) {
        ...
        result.onButtonClick = function (e, data) {
            self._onButtonClick(e, data);
        };
    }
...
primitives.orgeditor.DlgConfig = function () {
    ...
    this.enums = {
        ...
        verticalAlignment: {
            name: primitives.common.VerticalAlignmentType,
            title: "Items Vertical Alignment",
            isString: false
        },
        horizontalAlignment: {
            name: primitives.common.HorizontalAlignmentType,
            title: "Items Horizontal Alignment",
            isString: false
        },
        ...
        childrenPlacementType: {
            name: primitives.common.ChildrenPlacementType,
            title: "Children placement",
            isString: false
        },
        leavesPlacementType: {
            name: primitives.common.ChildrenPlacementType,
            title: "Leaves placement",
            isString: false
        },
    ...
    this.enums = {
        itemType: {
            name: {
                ...
                LimitedPartner: 7,
                AdviserPartner: 8
            }, title: "Item type", isString: false
        },
        adviserPlacementType: {
            name: primitives.common.AdviserPlacementType,
            title: "Adviser placement",
            isString: false
        },
        childrenPlacementType: {
            name: primitives.common.ChildrenPlacementType,
