    ...
    c.prototype = {
        constructor: c, destroy: function () {
            ...
            if (m.find(".step-pane").removeClass("active"), m.find('.step-pane[data-step="' + n + '"]:first').addClass("active"), "undefined" != typeof this.initialized) {
                ...
                this.$element.trigger(o, {step: this.currentStep})
            }
            this.initialized = !0
        }, stepclicked: function (b) {
            var c = a(b.currentTarget), d = this.$element.find(".steps li").index(c), e = !0;
            ...
            var b = this.currentStep + 1 <= this.numSteps, c = this.currentStep === this.numSteps;
            if (b) {
            ...
            var b, c;
            return a ? (c = a.step || -1, c >= 1 && c <= this.numSteps ? (this.currentStep = c, this.setState()) : (c = this.$element.find(".steps li.active:first").attr("data-step"), isNaN(c) || (this.currentStep = parseInt(c, 10), this.setState())), b = this) : b = {step: this.currentStep}, b
        }
