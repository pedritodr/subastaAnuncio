...
!function (a) {
    ...
    a.create = function () {
        ...
        init: function () {
            ...
            -1 != a.inArray(b.keyCode, this.options.toggleKeyCodes) ? (b.preventDefault(), this.click()) : 13 == b.keyCode && a(this.element.form).trigger("submit")
        }, reset: function () {
            (this.element.defaultChecked && this.$off.hasClass("active") || !this.element.defaultChecked && this.$on.hasClass("active")) && this.change(this.element.defaultChecked)
        }
    };
    var c = a.extend({}, a.propHooks);
    return a.extend(a.propHooks, {
        checked: {
            set: function (b, d) {
            ...
            set: function (b, d) {
                var e = a.data(b, "bs.checkbox");
                e && b.disabled != d && e.toggle_disabled(), c.disabled && c.disabled.set && c.disabled.set(b, d)
            }
        }
    }), a.fn.checkboxpicker = function (c, d) {
        var e;
